...
The following examples highlight hypothesis-driven statistics that test the connection between two molecular phenomena: transcription factor occupancy versus gene expression. 
Many of these analyses informed figures <a href="/Publications/#37183501" target="_blank">in the publication</a> but were extraneous for the final manuscript.

We mentally idealize these processes to match the cartoons in our textbooks, but large datasets tell a different story. 
